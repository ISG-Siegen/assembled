...
class MetaTask:
    ...
    def read_predictions_from_metaflows(self, metaflows: List[MetaFlow]):
        ...
        for meta_flow in metaflows:
            print("#### Process Flow {} ####".format(meta_flow.flow_id))

            # -- Setup Column Names for MetaDataset
            col_name = "prediction_flow_{}_run_{}".format(meta_flow.flow_id, meta_flow.best_run_id)
    ...
    def read_selection_constraints(self, openml_metric_name: str, maximize_metric: bool, min_runs: int,
                                   nr_top_flows: int, test_run: bool):
        ...
        self.selection_constraints["min_runs"] = min_runs
        self.selection_constraints["nr_top_flows"] = nr_top_flows
        self.selection_constraints["test_run"] = test_run
    ...
    def read_metatask_from_files(self, input_dir: str, openml_task_id: int):
        ...
        # Post process categories (will e skipped if not classification)
    ...
    def filter_predictors(self, remove_bad_predictors: bool = True, remove_constant_predictors: bool = False,
                          ...
                          score_metric: Optional[object] = None, maximize_metric: Optional[bool] = None):
        ...
        score_metric : sklearn metric function, default=None
            The metric function used to determine if a predictors is wores than a random predictor.
