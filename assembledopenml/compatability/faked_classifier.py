...
class FakedClassifier(BaseEstimator, ClassifierMixin):
    ...
    def predict(self, X):
        ...
        # -- Check if fitted
        check_is_fitted(self, ["X_", "y_", "classes_", "n_features_in_", "predictions_", "oracle_index_",
    ...
    def predict_proba(self, X):
        ...
        # -- Check if fitted
        check_is_fitted(self, ["X_", "y_", "classes_", "n_features_in_", "confidences_", "oracle_index_",
