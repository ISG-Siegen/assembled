...
class DSEmpiricalPerformanceModel(AbstractEnsemble, AbstractDynamicSelector):
    ...
    wrong_prediction_penalty: float, default=0.2
    ...
    def __init__(self, base_models, epm, epm_error: str = "predict_proba", wrong_prediction_penalty: float = 0.2,
    ...
    def ensemble_fit(self, base_models_predictions: List[np.ndarray], labels: np.ndarray) -> NotImplementedError:
        raise NotImplemented("DSEmpiricalPerformanceModel requires passthrough!")

    def ensemble_predict(self, base_models_predictions: List[np.ndarray]) -> NotImplementedError:
        raise NotImplemented("DSEmpiricalPerformanceModel requires passthrough!")
