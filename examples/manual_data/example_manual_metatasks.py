...
# Select dataset
to_load = [(load_breast_cancer, "breast_cancer"), (load_digits, "digits"), (load_iris, "iris"), (load_wine, "wine")]
for i, (sklearn_load_dataset_function, dataset_name) in enumerate(to_load, 1):
    metatask_id = -i  # Negative number because not an OpenML task!
    ...
    cat_feature_names = []  # type: list[str]
    ...
    mt.init_dataset_information(dataset_frame, target_name=target_name, class_labels=class_labels,
                                ...
                                dataset_name=dataset_name, folds_indicator=fold_indicators
                                )
